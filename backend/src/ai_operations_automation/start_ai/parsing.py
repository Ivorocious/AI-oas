"""Authenticated route-local transport parsing for Start AI interpretation."""
...
from ai_operations_automation.start_ai.models import StartAiInterpretationRequest
...
async def parse_start_ai_command(request: Request) -> StartAiInterpretationRequest:
    ...
    try:
        return StartAiInterpretationRequest.model_validate(parsed)
