...
| 3 — Proposal and approval | Published at `619f2166c9e7e8c5e5c5ddae0e694cf7186069b8`; hardening correction gate passed, correction publication pending | `0011_proposal_approval_foundation` | 26 | 566 offline and 345 PostgreSQL integration tests passed (911 collected); correction proves exact decision replay identity, truthful revision evidence, independent-session concurrency, rollback, HTTP contracts, and redaction without schema or route changes. |
